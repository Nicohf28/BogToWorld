// frontend/src/pages/footer_pages/Privacidad.tsx

export default function Privacidad() {
  return (
    <div className="my-4">
      <h1>Política de Privacidad</h1>
      <p>En BogToWorld nos comprometemos a proteger tus datos personales y tu privacidad.</p>
      ...
      <section className="mb-4">
        ...
        <p>Tomamos medidas técnicas y organizativas para proteger tus datos de accesos no autorizados, pérdidas o divulgación.</p>
      </section>

      <section className="mb-4">
        <h3>4. Compartir información</h3>
        <p>No vendemos tus datos personales a terceros. Solo compartimos información con proveedores necesarios para ofrecer nuestros servicios.</p>
      </section>
