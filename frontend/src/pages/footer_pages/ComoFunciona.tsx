  ...
  return (
    <div className="ajustes-container">
      ...
      <section className="ajustes-section">
        ...
        <ul>
          <li>Restaurantes: descubre la gastronomía local.</li>
          <li>Parques Naturales: espacios verdes y recreativos.</li>
          <li>Museos: conoce la historia y cultura.</li>
          <li>Miradores: disfruta de vistas panorámicas.</li>
        </ul>
      </section>
      ...
      <section className="ajustes-section">
        ...
        <ul>
          <li>Valora los lugares que visitas.</li>
          <li>Escribe reseñas detalladas.</li>
          <li>Agrega fotos para enriquecer tu reseña.</li>
        </ul>
      </section>
      ...
      <section className="ajustes-section">
        ...
        <ul>
          ...
          <li>Comparte tus favoritos con amigos.</li>
        </ul>
      </section>
      ...
      <section className="ajustes-section">
        ...
        <ul>
          <li>Ajusta tus preferencias de idioma.</li>
          <li>Configura alertas de nuevos lugares o reseñas.</li>
          <li>Gestiona la privacidad de tus datos y actividades.</li>
        </ul>
      </section>
    </div>
  );
